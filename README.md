...
- A `main.py` script equipped with a functional GUI **Streamlit Web Application** that lets you choose a provider and run your prompt interactively.
...
3. Deploy an app from an existing repository and configure the "Main file path" as `main.py`.
